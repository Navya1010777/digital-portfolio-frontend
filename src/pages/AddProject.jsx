...
const AddProject = () => {
  ...
  const handleChange = (e) => {
    ...
    // Show preview when an image URL is entered
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await api.createProject(formData, portfolioId);
    ...
    <div className="container mx-auto p-6 max-w-3xl">
      <div className="bg-white rounded-xl shadow-lg p-8 border border-gray-100">
        <div className="flex justify-between items-center mb-8">
          <h1 className="text-3xl font-bold text-gray-800 gradient-text">Add New Project</h1>
          <Link 
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500 mt-2 italic">
              Add a URL to an image that showcases your project
            </p>
            
            {formData.imageUrl && preview && (
              <div className="mt-4 relative">
                <p className="text-sm font-medium text-gray-700 mb-2">Image Preview:</p>
                <div className="relative overflow-hidden rounded-lg shadow-md bg-gray-100 h-52 flex items-center justify-center">
                  <img
          ...
          <div>
            ...
            />
            <p className="text-sm text-gray-500 mt-2 italic">
              Link to your GitHub repository, live demo, or other relevant URL
            </p>
          </div>
